    ...
    <div className="space-y-12">
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-brand-600 to-brand-700 p-10 text-white">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <Link href="/registro" className="btn bg-white text-brand-700 hover:bg-brand-50">Registrarme</Link>
          <Link href="/verificar" className="btn border border-white text-white hover:bg-white/10">
      ...
      <section className="card p-6">
        ...
        <ol className="mt-3 list-decimal space-y-1 pl-6 text-slate-700">
          <li>El docente completa el formulario de registro (DNI y WhatsApp).</li>
          <li>En cada sesión, el administrador escanea el código de barras del DNI del docente.</li>
        ...
        <Link href="/verificar" className="mt-4 inline-block text-brand-700 underline">
