...
function LoginForm() {
  ...
  return <LoginInner initialRole={initialRole} router={router} />;
}

export default function LoginPage() {
  return (
    <Suspense fallback={<div className="mx-auto max-w-md"><p className="text-slate-600">Cargando…</p></div>}>
      <LoginForm />
    </Suspense>
  );
}

function LoginInner({ initialRole, router }: { initialRole: "admin" | "docente"; router: ReturnType<typeof useRouter> }) {
